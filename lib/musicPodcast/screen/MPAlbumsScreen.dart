...
import 'package:audio_book/musicPodcast/screen/MPAlbumsDetailScreen.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: widget.isTab!
            ...
            : AppBar(
                backgroundColor: mpAppBackGroundColor,
                title: Text("Playlists", style: boldTextStyle(color: white.withOpacity(0.9), size: 18)),
                centerTitle: true,
          ...
          child: Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Top Playlist', style: boldTextStyle(color: Colors.white)).onTap(() {}),
                  Text('View All', style: primaryTextStyle(color: mpAppButtonColor)).paddingOnly(right: 8).onTap(() {
                    MPSongsScreen().launch(context);
                  }),
                ],
