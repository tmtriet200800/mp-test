...
import 'package:audio_book/musicPodcast/component/MPDrawerScreen.dart';
import 'package:audio_book/musicPodcast/models/MusicModel.dart';
import 'package:audio_book/musicPodcast/screen/MPNowPlayingScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: mpAppBackGroundColor,
        elevation: 0.0,
        title: Text("Books", style: boldTextStyle(color: Colors.white.withOpacity(0.9))),
        actions: [
        ...
        children: [
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text('Popular ooks', style: boldTextStyle(color: white.withOpacity(0.9))).paddingOnly(left: 16, right: 16),
                Container(
                  height: 200,
                ...
                8.height,
                Text('Friend Favorite Books', style: boldTextStyle(color: white.withOpacity(0.9))).paddingOnly(left: 16, right: 16),
                ListView.separated(
